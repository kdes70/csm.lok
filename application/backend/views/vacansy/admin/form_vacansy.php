            ...
            <p><!--  TYPE -->
                ...
                <small>(При отклике на вакансию соискатель заполнит анкету того или иного типа)</small>
                    ...
                    <select name="id_type" id="id_type">
                        <option value="1">Медицинский персонал</option>
                        <option value="2">Не медицинский персонал</option>
                    </select>
            </p><!--  TYPE -->
            <p>
                <label for="priority">Приоритет обычный</label><br>
                <?php echo form_radio('priority','0', TRUE); ?><br>
                 <label for="priority">Приоритет важный</label><br>
                <?php echo form_radio('priority', '1'); ?>
