<section id="content">
	  <div class="vacansy_form_block">
           ...
           <?php echo form_open('admin/vacansy/edit/'.$vacansy->id_vac); ?> 
	...
	<fieldset>
		<legend>1. Сведения о вакансии</legend>
			<p>
				...
				<?php endforeach; ?>
					<?php echo form_dropdown('city', $option, set_value('city', $vacansy->city), ' id="city"'); ?> 
				<?php endif; ?>
			...
			<?php if($local): ?>
				...
				<?php endforeach; ?>
			  <?php echo form_dropdown('id_loc', $option, set_value('id_loc', $vacansy->id_loc), ' id="id_loc"'); ?> 
			<?php endif; ?>
			</p>
			<p>
	...
	<fieldset>
		<legend>Контактное лицо по вакансии</legend>
			<p>
				...
				<?php echo form_input('author', set_value('author', $vacansy->author), 'id="author" maxlength="100"'); ?>
				</label>
			</p>
			<p>
	 			<label for="phone">Контактный телефон <span class="red">*</span><br>
	 			<?php echo form_input('phone', set_value('phone', $vacansy->phone), 'id="phone" maxlength="30"'); ?>
	 			</label>
	 		</p>
      		<p>
       			<label for="email">Email <span class="red">*</span><br>
       			<?php echo form_input('email', set_value('email', $vacansy->email), 'id="email" maxlength="30"'); ?>
       			</label>
       		</p>
...
<p>
	<label for="desc_profession">Основные обязанности <br>
		<?php echo form_textarea('desc_candidate', set_value('desc_candidate', $vacansy->desc_candidate)); ?>
	</label>
</p>
...
<p>
	...
	<?php echo form_input('education', set_value('education', $vacansy->education), 'id="education" maxlength="30"'); ?>
	</label>
</p>
<p>
	<label for="profes_profession">Специальность<br>
	<?php echo form_input('profes_profession', set_value('profes_profession', $vacansy->profes_profession), 'id="profes_profession" maxlength="30"'); ?>
	</label>
</p>
...
<p>
	...
	<small style="font-size: 12px">(наличие определенных навыков, умение выполнять определенные манипуляции, сертификаты и т.д.)</small>
		...
		<?php echo form_textarea('special_requirement', set_value('special_requirement', $vacansy->special_requirement)); ?>
		</label>
</p>
<p>
	<label for="other_requirements">Другие требования, на которые хотели бы обратить внимания<br>
	<?php echo form_input('other_requirements', set_value('other_requirements', $vacansy->other_requirements), 'id="other_requirements" maxlength="30"'); ?>
	</label>
</p>
</fieldset>
...
<p>
	...
	<?php echo form_input('workplace', set_value('workplace', $vacansy->workplace), 'id="workplace" maxlength="30"'); ?>
	</label>
</p>
...
<p>
	...
	<?php echo form_input('nature_work', set_value('nature_work', $vacansy->nature_work), 'id="nature_work" maxlength="30"'); ?>
	</label>
</p>
...
<p>
	...
	<?php echo form_input('wage_rate', set_value('wage_rate', $vacansy->wage_rate), 'id="wage_rate" maxlength="30"'); ?>
	</label>
</p>
<p>
	<label for="additional_terms">Дополнительные условия:<br>
	<small>(компенсация, оплата проживания, проезда, переезда и т.д.)</small><br>
		<?php echo form_textarea('additional_terms', set_value('additional_terms', $vacansy->additional_terms)); ?>
	</label>
</p>
</fieldset>
